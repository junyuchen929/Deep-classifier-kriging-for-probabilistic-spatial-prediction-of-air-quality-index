...
library(MASS)
library(fields)
setwd("/Users/beauniverse/Documents/GitHub/Deep-classifier-kriging-for-probabilistic-spatial-prediction-of-air-quality-index/dck_bi/dck_bi")
mainDir <- "."
...
for(i in 1:num_sim){
  ...
  write.csv(x = df,
            file = paste0("synthetic_data_simulations/2d_gaussian_1600_",i,".csv"),
            row.names = F)
}
