...
for(sim in 1:num_sim){
  file_path <- paste0("synthetic_data_simulations/2d_nongaussian_3600_",sim,".csv")
  ...
  write.csv(x = df_threshold2,
            file = paste0("synthetic_data_simulations/2D_nonGaussian_3600_projection_",sim,".csv"),
            row.names = F)
}
